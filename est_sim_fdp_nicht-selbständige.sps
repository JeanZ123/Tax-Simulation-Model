...
GET
    FILE='C:\Users\Marius\Desktop\Statistics\Projects\SPSS\Mikrosimulation_ESt\Gesamttabelle\Berufe & Gewerbe\est_sim_fdp_nicht-selbständige.sav'.
...
DO IF (sde_neu GE 0 AND sde_neu LE 18246).
    COMPUTE p=1.  
ELSE IF (sde_neu GE 18247 AND sde_neu LE 28683).
     COMPUTE p=2.
ELSE IF (sde_neu GE 28684 AND sde_neu LE 37014).
     COMPUTE p=3.
ELSE IF (sde_neu GE 37015 AND sde_neu LE 45216).
    COMPUTE p=4.
ELSE IF (sde_neu GE 45217 AND sde_neu LE 53999).
   COMPUTE p=5.
ELSE IF (sde_neu GE 54000 AND sde_neu LE 63993).
   COMPUTE p=6.
ELSE IF (sde_neu GE 63994 AND sde_neu LE 76067).
    COMPUTE p=7.
ELSE IF (sde_neu GE 76068 AND sde_neu LE 94285).
    COMPUTE p=8.
ELSE IF (sde_neu GE 94286 AND sde_neu LE 127517).
    COMPUTE p=9.
ELSE IF (sde_neu GE 127518).
    COMPUTE p=10.
END IF.
