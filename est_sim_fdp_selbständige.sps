...
GET
    FILE='C:\Users\Marius\Desktop\Statistics\Projects\SPSS\Mikrosimulation_ESt\Gesamttabelle\Berufe & Gewerbe\est_sim_fdp_selbständige.sav'.
...
DO IF (sde_neu GE 0 AND sde_neu LE 14691).
    COMPUTE p=1.  
ELSE IF (sde_neu GE 14692 AND sde_neu LE 26688).
     COMPUTE p=2.
ELSE IF (sde_neu GE 26689 AND sde_neu LE 39796).
     COMPUTE p=3.
ELSE IF (sde_neu GE 39797 AND sde_neu LE 54156).
    COMPUTE p=4.
ELSE IF (sde_neu GE 54157 AND sde_neu LE 70648).
   COMPUTE p=5.
ELSE IF (sde_neu GE 70649 AND sde_neu LE 90944).
   COMPUTE p=6.
ELSE IF (sde_neu GE 90945 AND sde_neu LE 118467).
    COMPUTE p=7.
ELSE IF (sde_neu GE 118468 AND sde_neu LE 161336).
    COMPUTE p=8.
ELSE IF (sde_neu GE 161337 AND sde_neu LE 252220).
    COMPUTE p=9.
ELSE IF (sde_neu GE 252220).
    COMPUTE p=10.
END IF.
